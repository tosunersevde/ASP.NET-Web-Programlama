...
namespace Moqups.Infrastructure.TagHelpers
{
    ...
    public class PageLinkTagHelper : TagHelper
    {
        ...
        [ViewContext]
        [HtmlAttributeNotBound] //Html sayfalariyla cakismasi istenmez.
        ...
        //        for (int i = 1; i <= PageModel.TotalPages; i++) //sayfa sayisi kadar doner, linkler olusturu.
        //        {
        //            TagBuilder tag = new TagBuilder("a");
        //            tag.Attributes["href"] = urlHelper.Action(PageAction, new { PageNumber = i });
        //            if(PageClassesEnabled) //PageClass ifadesi aciksa
        //            { 
